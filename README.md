# rn-pdf-component
[![npm](https://img.shields.io/npm/v/rn-pdf-component.svg?style=flat-square)](https://www.npmjs.com/package/rn-pdf-component)
...
So you should install rn-pdf-component and rn-blob-util

> The table below shows the supported versions of React Native and rn-blob-util for different versions of `rn-pdf-component`.

| React Native              | 0.4x - 0.56     | 0.57    | 0.60+    | 0.62+    | 0.62+    |
| ------------------------- | --------------- | ------- | -------- | -------- | -------- |
| rn-pdf-component          | 4.x.x - 5.0.x   | 5.0.9+  | 6.0.0+   | 6.2.0+   | 6.4.0+   |
| rn-blob-util    |                 |         |          |          | 0.13.7+  |


> 🚨 Expo: This package is not available in the [Expo Go](https://expo.dev/client) app. Learn how you can use this package in [Custom Dev Clients](https://docs.expo.dev/development/getting-started/) via the out-of-tree [Expo Config Plugin](https://github.com/expo/config-plugins/tree/master/packages/rn-pdf-component). Example: [`with-pdf`](https://github.com/expo/examples/tree/master/with-pdf).

### Installation

```bash
# Using npm
npm install rn-pdf-component rn-blob-util --save

# or using yarn:
yarn add rn-pdf-component rn-blob-util
```

Then follow the instructions for your platform to link rn-pdf-component into your project:
...
react-native link rn-pdf-component
```
</details>
...
You can add it manually. For detail you can see the issue [`#24`](https://github.com/wonday/rn-pdf-component/issues/24) and [`#2`](https://github.com/wonday/rn-pdf-component/issues/2)

Q2. When running, it shows ```'Pdf' has no propType for native prop RCTPdf.acessibilityLabel of native type 'String'```  
A2. Your react-native version is too old, please upgrade it to 0.47.0+ see also [`#39`](https://github.com/wonday/rn-pdf-component/issues/39)
...
A5. Run the following commands in the project folder (e.g. `rn-pdf-component/example`) to ensure that all dependencies are available:
```
...
[[more]](https://github.com/wonday/rn-pdf-component/releases)
